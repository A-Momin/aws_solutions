...
variable "PUBLIC_SUBNETS" {
  ...
  default = {
    ...
    public_subnet_3 = { cidr_block = "20.20.40.0/24", availability_zone = "us-east-1c" }
  }
}
...
variable "PRIVATE_SUBNETS" {
  ...
  default = {
    ...
    private_subnet_3 = { cidr_block = "20.20.104.0/24", availability_zone = "us-east-1c" }
  }
}

variable "BUCKETS" {
  type    = list(string)
  default = ["datalake-bkt-12302025", "glue-assets-bkt-12302025", "glue-temp-bkt-12302025"]
}
