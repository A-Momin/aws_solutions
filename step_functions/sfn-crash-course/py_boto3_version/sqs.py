...
def create_sqs_queue(queue_name, attributes):
    """
...
def send_message_to_sqs_queue(queue_url, message_body, message_attributes=None):
    ...
    try:
        ...
        print(f"ERROR SENDING MESSAGE TO SQS QUEUE!!!!!!!!!!!!!!!!!!!!")
        print(e)
        return None
...
def receive_messages_from_sqs_queue(queue_url, max_number_of_messages=1, wait_time_seconds=0):
    ...
    try:
        ...
        print(f"ERROR RECEIVING MESSAGES FROM SQS QUEUE!!!!!!!!!!!!!!!!!!")
        print(e)
        return []
...
def delete_sqs_queue(queue_url):
    ...
    try:
        ...
        print(f"ERROR DELETING SQS QUEUE!!!!!!!!!!!!!!!!")
...
def create_all_sqs():
    ...
    # Create an SQS queue
    queue_response = create_sqs_queue(queue_name, attributes={
        'DelaySeconds': '5',
